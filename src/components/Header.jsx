    ...
    <header className="fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16">
      ...
      <div className="hidden md:flex w-full h-full items-center justify-between">
        <Link to={"/"} className="flex items-center gap-2">
          ...
          */}
          <p className="text-xl font-bold text-white"> GM - VAPE</p>
        </Link>
        ...
        <div className="flex items-center gap-8">
          ...
          >
            <li className="text-lg hover:text-blue-700 duration-100 transition-all ease-in-out cursor-pointer text-white">
              <Link to={"/"}>
                Home
              </Link>
            </li>
          ...
          <div className="relative">
            ...
            {isMenu && (
              ...
              >
                {user && user.email === "thomas.loysance@gmail.com" && (
                  <Link to={"/createItem"}>
      ...
      <div className="flex items-center justify-between md:hidden w-full h-full ">
        ...
        <Link to={"/"} className="flex items-center gap-2">
          {/*<img src={Logo} className="w-8 object-cover" alt="logo" />*/}
          <p className="text-headingColor text-xl font-bold"> GM - Vape</p>
        </Link>
        ...
        <div className="relative">
          ...
          {isMenu && (
            <motion.div
              ...
              className="w-40 bg-gray-50 shadow-xl rounded-lg flex flex-col absolute top-12 right-0"
            >
              if (user.email == "thomas.loysance@gmail.com") {
                <Link to={"/createItem"}>
